...
//   // ✅ Ensure sidebar is collapsed initially if in mobile view
//   if (isMobileView()) {
//     sidebar.classList.add("collapsed");
//   }
...
//         !sidebar.contains(e.target) &&
//         !sidebarToggle.contains(e.target) &&
//         (!navbarDropdownBtn || !navbarDropdownBtn.contains(e.target))
//       ) {
//         sidebar.classList.add("collapsed");
//       }
//     });
...
//     // ✅ Auto-collapse sidebar when switching to mobile mode
//     window.addEventListener("resize", function () {
//       if (isMobileView()) {
//         sidebar.classList.add("collapsed"); // Ensure sidebar collapses in mobile mode
//       } else {
//         sidebar.classList.remove("collapsed"); // Show sidebar in desktop mode
//       }
//     });
//   } else {
//     console.error("Error: Sidebar or toggle button not found.");
